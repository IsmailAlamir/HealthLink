...
import com.example.healthlink.profileSetting.ProfileSettingActivity;
...
public class OnBoardingActivity extends AppCompatActivity {
    ...
    private void setOnBoardingItems(){
        ...
        onBoardingItems.add(new OnBoardingItem("Welcome to HealthLink !","Managing your health has never been easier.",R.drawable.docs_1));
        onBoardingItems.add(new OnBoardingItem("Discover HealthLink's Features","stay connected with your healthcare providers, schedule appointments, and access your medical records—all in one place",R.drawable.docs_2));
        onBoardingItems.add(new OnBoardingItem("Experience the Benefits","Ready to experience the transformation? Create an account or log in to start your journey with HealthLink.",R.drawable.doc_office));
